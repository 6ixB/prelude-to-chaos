...
@Mod(PreludeToChaos.MOD_ID)
public class PreludeToChaos {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "prelude_to_chaos";
    ...
    public PreludeToChaos(FMLJavaModLoadingContext context) {
